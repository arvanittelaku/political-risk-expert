...
export const APP_STATIC_PATHS: PublicUrlEntry[] = [
  ...
  { path: "/political-risk-explained", priority: 0.95, changefreq: "monthly" },
  { path: "/practice-areas", priority: 0.93, changefreq: "monthly" },
  { path: "/risk-types", priority: 0.92, changefreq: "monthly" },
  { path: "/case-types", priority: 0.9, changefreq: "monthly" },
  { path: "/services", priority: 0.9, changefreq: "monthly" },
  { path: "/what-is-a-political-risk-expert", priority: 0.9, changefreq: "monthly" },
