...
/** Registry of third-party scripts gated by consent - nothing loads until granted */
  ...
  return [
    {
      ...
      load: () => {
        ...
        injectScript("pge-gtag-js", `https://www.googletagmanager.com/gtag/js?id=${gaId}`);
        const inline = document.createElement("script");
        inline.id = "pge-gtag-inline";
        inline.textContent = `
      ...
      unload: () => {
        removeScript("pge-gtag-js");
        removeInlineScript("pge-gtag-inline");
    ...
    },
    {
      ...
      unload: () => {
        removeInlineScript("pge-gtm-inline");
    ...
    },
    {
      ...
      unload: () => {
        removeInlineScript("pge-meta-pixel");
    ...
    },
    {
      ...
      load: () => {
        ...
        const inline = document.createElement("script");
        inline.id = "pge-linkedin-insight";
        inline.textContent = `
      ...
      unload: () => {
        removeInlineScript("pge-linkedin-insight");
        removeScript("pge-linkedin-js");
